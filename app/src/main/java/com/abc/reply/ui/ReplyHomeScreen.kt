...
import com.abc.reply.R
import com.abc.reply.data.Email
import com.abc.reply.data.MailboxType
import com.abc.reply.data.local.LocalAccountsDataProvider
...
fun ReplyHomeScreen(
    ...
    val navigationItemContentList = listOf(
        NavigationItemContent(
            ...
            icon = ImageVector.vectorResource(R.drawable.ic_drafts),
    ...
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER) {
        ...
        // For compact (bottom) and medium (rail). See ReplyAppContent
        if (replyUiState.isShowingHomepage) {
            ...
            // if is not home screen. no navigation element needed. it is full screen details page
            ReplyDetailsScreen(
                replyUiState = replyUiState,
                isFullScreen = true,
